export class CryptoManager {
  ...
  static async encrypt(publicKey: CryptoKey, data: string): Promise<{ ciphertext: string; iv: string }> {
...
export async function encryptLocal(key: CryptoKey, data: string): Promise<{ciphertext: ArrayBuffer, iv: Uint8Array}> {
...
export async function decryptLocal(key: CryptoKey, ciphertext: ArrayBuffer, iv: Uint8Array): Promise<string> {
